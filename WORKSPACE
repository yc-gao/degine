...
http_archive(
    name = "llvm_zlib",
    build_file = "//3rdparty/llvm-project/third_party_build:zlib-ng.BUILD",
...
http_archive(
    name = "llvm_zstd",
    build_file = "//3rdparty/llvm-project/third_party_build:zstd.BUILD",
    sha256 = "7c42d56fac126929a6a85dbc73ff1db2411d04f104fae9bdea51305663a83fd0",
    strip_prefix = "zstd-1.5.2",
    url = "https://github.com/facebook/zstd/releases/download/v1.5.2/zstd-1.5.2.tar.gz",
)
load("//3rdparty/llvm-project:configure.bzl", "llvm_configure")
llvm_configure(
    name = "llvm-project",
